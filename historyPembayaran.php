...
<body>
    ...
    <br>
    <a href="http://localhost/pos/uas_weddas/pembayaran.php" class="btn">Insert Transaksi
    ...
    <div>
    <br>
    <a href="http://localhost/pos/uas_weddas/menuKasir.php" class="btn btn-secondary">Kembali
