...
<body>
    ...
    <br>
    <br>
    <a href="../../form/member.php" class="btn btn-primary">Insert Data</a>
    <table border="1">
    <tr>
        <th>no</th>
        <th>id_member </th>
       ...
       <td><?php echo $no++; ?></td>
        ...
        <td>
            <div class="btn-container">
                <a href="formEdit.php?id_member=<?php echo $d['id_member']; ?>" class="btn btn-warning btn-sm">Edit</a>
                <a href="delete.php?id_member=<?php echo $d['id_member']; ?>" class="btn btn-danger btn-sm">Hapus</a>
            </div>
        </td>
       </tr>
       <?php
